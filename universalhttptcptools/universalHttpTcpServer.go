/*
Package universalhttptcptools provides tools universal handeling TCP and WebSocket traffic, because they work almost the same
*/
...
func (sv *Server) readFuncTCP(conn *tcptools.ServerConn, data []byte, status uint8) {
	if sv.readFunc != nil {
