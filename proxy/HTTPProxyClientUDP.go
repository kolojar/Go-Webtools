...
func NewHTTPProxyClientUDP(httpProxyAddress string, tcpServerAddress string, reportTraffic bool) (*HTTPProxyClientUDP, error) {
	cl := &HTTPProxyClientUDP{clientToID: helpertools.MakeSafeMap[*udp.ServerConn, string](), pendingConnections: helpertools.MakeSafeMap[string, *udp.ServerConn](), idToClient: helpertools.MakeSafeMap[string, *udp.ServerConn](), pendingConnsData: helpertools.MakeSafeMap[*udp.ServerConn, [][]byte]()}
	var err error
